package com.gmr.netty.chapter10.httpxml;
...
public class GenBindFileTool {
	...
	private static void compile() {
		...
		args[1] = "./src/main/java/com/gmr/netty/chapter10/httpxml/pojo/order/binding.xml";
	...
	private static void genBindFiles() throws JiBXException, IOException {
		...
		args[6] = "-t";
		args[7] = "./src/main/java/com/gmr/netty/chapter10/httpxml/pojo/order";

		// 告诉 BindGen 使用下面的类作为 root 生成 binding 和 schema。必须
		args[8] = "com.gmr.netty.chapter10.httpxml.pojo.Order";
